...
Evaluation of the trained network can be done by running eval.py file. Pycocotools needs to be installed on Windows operating system. In the Conda virtual environment  execute the following command:
