...
A number of tests were performed on the SSD MobileNet v2 network in order to get optimal performance in terms of speed and mAP score [Evaluation metrics](Evaluation Metrics.md). The sequence of the performed tests were:
...
**Case 1**: Optimization of network based on hyperparameters [Tweaking and Tuning of Hyperparameters](Tweaking and Tuning of Hyperparameters.md)
